...
//import com.iclnetwork.web.entity.AdminEntity;
//import com.iclnetwork.web.enums.AccountLockTypeEnum;
//import com.iclnetwork.web.enums.CaptchaTypeEnum;
//import com.iclnetwork.web.service.AdminService;
//import com.iclnetwork.web.service.CaptchaService;
//import com.iclnetwork.web.setting.security.SecuritySetting;
//import com.iclnetwork.web.util.SettingUtils;
...
//        HttpSession session = authenticationToken.getSession();
//
//        // 启用管理员登录验证码时，验证验证码
//        if (!captchaService.verify(CaptchaTypeEnum.adminLogin, captcha, session)) {
//            // 异常：无效令牌
