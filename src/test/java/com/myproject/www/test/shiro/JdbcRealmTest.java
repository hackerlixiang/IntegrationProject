...
public class JdbcRealmTest {  
  ...
  public void test() {  
      ...
      Factory<SecurityManager> factory = new IniSecurityManagerFactory("classpath:com/myproject/www/test/shiro/jdbc.ini");  
      ...
      // 4.创建用户登录凭证  
      UsernamePasswordToken token = new UsernamePasswordToken("lx027880", "f6e9864aaf2f396e0d7c926ee4426800");  
